    ...
    public void dataPlus(){
        ...
        try{
            ...
            if(resultSet != null){
                ...
                ResultSet resultSet1=con.connexionBase(req);
                if(resultSet1 != null){
                    //on passe à la ligne suivante car titre des variables
                    resultSet1.next();
            ...
            ResultSet resultSet2=con.connexionBase(req);
            if(resultSet2 != null){
                //on passe à la ligne suivante car titre des variables
                resultSet2.next();
                ...
                ResultSet resultSet3=con.connexionBase(req);
                if(resultSet3 != null){
                    //on passe à la ligne suivante car titre des variables
                    resultSet3.next();
            ...
            ResultSet resultSet4=con.connexionBase(req);
            if(resultSet4 != null){
                //on passe à la ligne suivante car titre des variables
                resultSet4.next();
                ...
                ResultSet resultSet5=con.connexionBase(req);
                if(resultSet5 != null){
                    ...
                    ResultSet resultSet6=con.connexionBase(req);
                    if(resultSet6 != null){
                        //on passe à la ligne suivante car titre des variables
                        resultSet6.next();
